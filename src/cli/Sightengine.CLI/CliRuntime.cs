...
internal static class CliRuntime
{
    ...
    public static async Task<global::Sightengine.SightengineClient> CreateClientAsync(ParseResult parseResult, CancellationToken cancellationToken = default)
    {
    ...
    private static async Task WriteApiExceptionAsync(global::Sightengine.ApiException exception)
    {
        var builder = new StringBuilder();

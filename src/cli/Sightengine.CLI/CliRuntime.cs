...
namespace Sightengine.CLI;

internal static class CliRuntime
{
    private const string UserSecretsId = "Sightengine.CLI";
    private const string UserSecretApiKeyName = "SIGHTENGINE_API_KEY";
    private static readonly string[] ApiKeyEnvironmentVariables = [@"SIGHTENGINE_API_KEY"];
    private const string CredentialFileDirectoryName = ".sightengine";

    public static async global::System.Threading.Tasks.Task<global::Sightengine.SightengineClient> CreateClientAsync(ParseResult parseResult, CancellationToken cancellationToken = default)
    {
        ...
        return new global::Sightengine.SightengineClient(
            httpClient: null,
            baseUri: baseUri,
    ...
    private static Uri? ResolveBaseUri(ParseResult parseResult)
    {
        ...
        {
            baseUrl = Environment.GetEnvironmentVariable("SIGHTENGINE_BASE_URL");
        }
    ...
    private static async global::System.Threading.Tasks.Task WriteApiExceptionAsync(global::Sightengine.ApiException exception)
    {
        var builder = new StringBuilder();

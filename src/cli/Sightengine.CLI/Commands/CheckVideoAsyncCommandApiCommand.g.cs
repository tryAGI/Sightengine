...
internal static partial class CheckVideoAsyncCommandApiCommand
{
    ...
    private static Option<string?> StreamUrl { get; } = new(
        name: @"--stream-url")
    {
        Description = @"Public URL of the video or live stream.",
    };

    private static Option<string?> CallbackUrl { get; } = new(
        name: @"--callback-url")
    {
        Description = @"Webhook URL to receive moderation results.",
    };
...
",
      ...
      private static Option<string?> RequestFile { get; } = new(@"--request-file")
      {
          ...
          Hidden = true,
                    ...
                    private static string FormatResponse(ParseResult parseResult, global::Sightengine.VideoCheckAsyncResponse value, global::System.Text.Json.Serialization.JsonSerializerContext context, bool truncateLongStrings)
                    {
                        string? text = null;
                    ...
                    static partial void CustomizeResponseText(ParseResult parseResult, global::Sightengine.VideoCheckAsyncResponse value, ref string? text);
...
");
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            ...
            {
                        var __requestBase = await CliRuntime.ReadRequestOrDefaultAsync<global::Sightengine.CheckVideoAsyncRequest>(
                            parseResult,
                            Input,
                            RequestJson,
                            RequestFile,
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.CheckVideoAsyncAsync(
                                    media: media,
                                    medianame: medianame,
                                    streamUrl: streamUrl,

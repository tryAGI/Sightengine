...
namespace Sightengine
{
    public partial class SightengineClient
    {
        ...
        partial void PrepareCheckVideoSyncRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Sightengine.CheckVideoSyncRequest request);
        partial void ProcessCheckVideoSyncResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCheckVideoSyncResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Sightengine.VideoCheckSyncResponse> CheckVideoSyncAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCheckVideoSyncArguments(
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Sightengine.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Sightengine.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "CheckVideoSync",
                                methodName: "CheckVideoSyncAsync",
                                pathTemplate: "\"/video/check-sync.json\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::Sightengine.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCheckVideoSyncResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<global::Sightengine.VideoCheckSyncResponse> CheckVideoSyncAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Sightengine.CheckVideoSyncRequest
            {
                Media = media,
                Medianame = medianame,
                StreamUrl = streamUrl,
            ...
            return await CheckVideoSyncAsync(
                request: __request,
                requestOptions: requestOptions,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var request = new global::Sightengine.CheckVideoSyncRequest
            {
